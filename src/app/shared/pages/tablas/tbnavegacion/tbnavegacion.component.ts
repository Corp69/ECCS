...
@Component({
  ...
  templateUrl: './tbnavegacion.component.html',
  styleUrl: './tbnavegacion.component.scss'
})
export class tbnavegacionComponent implements OnInit {
 ...
 public  Seleccionar( args: any ){ this.router.navigate([ `/ControlRh/empleado/${ args.id }`]);}
